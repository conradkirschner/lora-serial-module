...
var _terminal_icon = _interopRequireDefault(require("../img/terminal_icon.png"));
...
},{"../img/terminal_icon.png":"img/terminal_icon.png","./../../src/client/packages/types":"../src/client/packages/types.js","../../src/client/packages":"../src/client/packages/index.js","./errorModal":"js/errorModal.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../src/client/commands/lora.js":[function(require,module,exports) {
"use strict";
...
var attachEvents = function attachEvents(id) {
  ...
  currentSerialConsole.elements.$menu[6].querySelector('button').addEventListener('click', function () {
    var messagePackage = _index.default.send.send_text_request_ack();
